...
class UserProfileListSerializer(serializers.ModelSerializer):
    class Meta:
        model = UserProfile
        fields = ['id', 'username', 'first_name', 'last_name', 'avatar' ,'status', 'data_register']


class UserProfileDetailSerializer(serializers.ModelSerializer):
    class Meta:
        model = UserProfile
        fields = ['id', 'username', 'first_name', 'last_name', 'avatar', 'age', 'phone_number', 'data_register']
...
class ProductListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id', 'subcategory', 'product_name', 'product_img', 'price', 'get_avg_rating', 'get_count_rating']
...
class ProductDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id', 'subcategory', 'product_name', 'product_img', 'description', 'price', 'article', 'product_type', 'product_review', 'created_date']